...
entity2id_fid.write(str(len(entity_list))) #this is just for transD ,another please delete this code
entity2id_fid.write('\n')
...
relation2id_fid.write(str(len(relation_list)))#this is just for transD ,another please delete this code
relation2id_fid.write('\n')
count = 0 
