...
public:
    ...
    void run()
    {
        FILE* f1 = fopen(("./"+ds_name+"/relation2vec."+version).c_str(),"r");
        FILE* f3 = fopen(("./"+ds_name+"/entity2vec."+version).c_str(),"r");
...
void prepare()
{
    FILE* f1 = fopen(("../data/"+ds_name+"/entity2id.txt").c_str(),"r");
	FILE* f2 = fopen(("../data/"+ds_name+"/relation2id.txt").c_str(),"r");
	int x;
    ...
    FILE* f_kb = fopen(("../data/"+ds_name+"/test.txt").c_str(),"r");
    ...
    fclose(f_kb);
    FILE* f_kb1 = fopen(("../data/"+ds_name+"/train.txt").c_str(),"r");
    ...
    fclose(f_kb1);
    FILE* f_kb2 = fopen(("../data/"+ds_name+"/valid.txt").c_str(),"r");
